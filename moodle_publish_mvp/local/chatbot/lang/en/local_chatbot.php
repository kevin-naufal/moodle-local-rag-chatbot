...
$string['chatmasterylabel'] = 'Mastery';
$string['chatmasteryunknown'] = 'Mastery: select class and topic';
$string['chatmasteryloading'] = 'Mastery: loading...';
$string['chatmasterynodata'] = 'Mastery: no data yet';
$string['taskmasterylabel'] = 'Topic mastery';
$string['taskmasteryunknown'] = 'Topic mastery: select class and topic';
$string['taskmasteryloading'] = 'Topic mastery: loading...';
$string['taskmasterynodata'] = 'Topic mastery: no data yet';
...
$string['assignmenttypeessay'] = 'Essay assignment';
...
$string['practicepagerange'] = 'Page range (optional)';
$string['practicepagestart'] = 'Start page';
$string['practicepageend'] = 'End page';
$string['practicepagerangehint'] = 'Leave empty to use all pages. Example: 10 to 20.';
...
$string['practicestopgenerating'] = 'Stop generating';
$string['practiceretryfailed'] = 'Retry failed question';
$string['practicecontinuepublish'] = 'Continue to publish phase';
$string['practiceprepare'] = 'Prepare publish template';
...
$string['practicepreparefirst'] = 'Prepare publish template first before publishing.';
$string['practiceprepared'] = 'Publish template is ready. Review and click Publish practice.';
$string['practiceparseerror'] = 'Failed to prepare publish template from generated practice.';
$string['practicephase1hint'] = 'Question bank generated. Click Prepare publish template before publishing.';
